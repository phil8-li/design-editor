...
export const OUTPUT_DETAILS: ReadonlyArray<{ id: OutputDetail; label: string; hint: string }> = [
  { id: "compact", label: "Compact", hint: "The note and what it points at" },
  { id: "standard", label: "Standard", hint: "Adds the selector, source and components" },
  { id: "detailed", label: "Detailed", hint: "Adds computed styles and ancestry" },
  { id: "forensic", label: "Forensic", hint: "Adds the environment and the full box" },
]
